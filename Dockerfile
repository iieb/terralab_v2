...
RUN mkdir -p /usr/src/terralab_v2
...
COPY src /usr/src/terralab_v2/
WORKDIR /usr/src/terralab_v2
...
RUN chmod +x /usr/src/terralab_v2/tasks.py \
    && chmod +x /usr/src/terralab_v2/entrypoint.sh
...
# ENTRYPOINT /usr/src/terralab_v2/entrypoint.sh
